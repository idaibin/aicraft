...
This protocol is shared by `chatgpt-review-bridge` and `ops-browser`. Each
...
route:
  browser_mode: <codex-in-app-browser|current-chrome-explicit|standalone-playwright-explicit|manual>
