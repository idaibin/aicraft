...
| Upgrade/publish | Compares only `skills/code-planner/`, previews before writing, and confirms discoverability with `npx skills add https://github.com/rustzen/aicraft --list` after publishing. | Overwrites directly or skips source validation or publishability checks. |
