...
| `Create a UI profile, reference registry, task tokens, and visual evaluation contract before implementation.` | Should prefer `design-system`. | UI design asset ownership. |
