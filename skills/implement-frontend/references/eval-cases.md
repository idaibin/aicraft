...
| `Create the UI direction, project profile, reference responsibilities, task tokens, and rubric, but do not edit product source.` | Should prefer `design-system`. | UI design asset ownership. |
