...
- shared primitives, feature components, hooks, services, stores, schemas,
...
| Hook | stateful behavior, effects, subscriptions, reusable orchestration | it only renames a function or hides trivial expressions |
