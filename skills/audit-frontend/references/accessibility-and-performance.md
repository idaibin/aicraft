...
1. Trace the interaction, render boundary, request path, cache updates, context
   or store subscribers, native calls, and loaded bundles.
...
- narrow subscriptions/selectors and context providers;
